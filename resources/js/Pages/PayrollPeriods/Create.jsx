    ...
    return (
        <AppLayout title="Create Payroll Period">
            ...
            <div className="p-2 sm:p-4">
                ...
                <p className="text-base-content/60 m-0">Pick a start date — end date and pay date are computed automatically</p>
                    ...
                    <div className="card bg-base-100 border border-base-300 p-0 overflow-hidden">
                        ...
                        <form onSubmit={submit} className="p-6">
                            <div className="mb-5">
                                ...
                                />
                                <p className="text-base-content/60 text-xs mt-1">The period will cover 15 days starting from this date.</p>
                            ...
                            <div className="mb-5">
                                <label className="label label-text font-semibold text-sm text-base-content">
                                    Cutoff End Date <span className="font-normal text-base-content/40 text-xs">— auto</span>
                                </label>
                            ...
                            <div className="mb-7">
                                <label className="label label-text font-semibold text-sm text-base-content">
                                    Payroll Date <span className="font-normal text-base-content/40 text-xs">— auto (5 days after end)</span>
                                </label>
