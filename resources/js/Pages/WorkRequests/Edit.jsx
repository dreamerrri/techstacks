    ...
    return (
        <AppLayout>
            ...
            <div className="p-2 sm:p-4">
                <div className="mb-5">
                    <Link href={`/work-requests/${workRequest.id}`} className="back-link text-dim-foreground no-underline text-sm hover:text-brand">
                ...
                <div className="rounded-xl border border-edge bg-card shadow-md p-6 max-w-3xl">
                    ...
                    <p className="text-dim-foreground text-sm mb-6">Modify your pending work request</p>
