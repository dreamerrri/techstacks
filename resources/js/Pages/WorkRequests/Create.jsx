...
export default function WorkRequestsCreate({ upcomingHolidays }) {
        ...
        <AppLayout>
            ...
            <div className="p-2 sm:p-4">
                ...
                <div className="card bg-base-100 shadow-md p-6 max-w-3xl">
                    ...
                    <p className="text-base-content/60 text-sm mb-6">Submit a request for weekend, holiday, or overtime work</p>
                    ...
                    <form onSubmit={submit}>
                        ...
                        {isOvertime && overtimeHours !== null && (
                            <div className="bg-info/10 border-s-4 border-primary rounded-lg p-3 mt-2 mb-4">
                        ...
                        <FormField label="Estimated Hours" error={errors.estimated_hours} help="Estimated duration of work (optional)">
                            <input
                                type="number"
                        ...
                        <FormField label="Reason" error={errors.reason} help="Maximum 500 characters">
                            <textarea
                                name="reason"
                                rows="4"
                                maxLength="500"
                        ...
                        <div className="flex gap-3 flex-wrap pt-4 border-t border-base-300">
                            ...
                            <Link href="/work-requests" className="btn btn-soft">Cancel</Link>
                        </div>
                    </form>
                </div>
