        ...
        <div className="mt-4 p-4 bg-success/10 rounded-xl border border-success/20">
            ...
            <form onSubmit={saveAllowance}>
                ...
                <div className="flex gap-2">
                    <button type="submit" className="btn btn-soft btn-success btn-sm" disabled={allowance.processing}>
                        <Icon name="ph--floppy-disk-fill" className="size-4" /> Save Allowance
                    </button>
                    <button type="button" onClick={() => setForm(null)} className="btn btn-soft btn-sm">Cancel</button>
                </div>
            </form>
        </div>
    );
    ...
    const benefitForm = (
        <div className="mt-4 p-4 bg-info/10 rounded-xl border border-info/20">
            ...
            <form onSubmit={saveBenefit}>
                ...
                <div className="flex gap-2">
                    <button type="submit" className="btn btn-soft btn-info btn-sm" disabled={benefit.processing}>
            ...
            <div className="p-2 sm:p-4">
                <div className="flex justify-between items-center flex-wrap gap-3 mb-5">
                    ...
                    <div className="flex gap-2 flex-wrap">
                        <Link href={`/employees/${employee.id}/edit`} className="btn btn-soft btn-warning btn-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="card bg-base-100 shadow-sm p-5 md:col-span-2">
