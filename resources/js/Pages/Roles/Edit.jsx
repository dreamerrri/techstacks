    ...
    return (
        <AppLayout>
            ...
            <div className="p-2 sm:p-4">
                <div className="mb-5">
                    <Link href={`/roles/${role.id}`} className="back-link text-dim-foreground no-underline text-sm hover:text-success">
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); put(`/roles/${role.id}`); }}>
                        ...
                        <div className="mb-8">
                            ...
                            {Object.keys(permissions || {}).length > 0 ? (
                                ...
                                <p className="text-dim-foreground/70 text-sm m-0">No permissions available.</p>
                            )}
                        </div>
