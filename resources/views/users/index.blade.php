...
@section('content')
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5 ">
        <div class="card bg-base-100 border border-base-300  p-5 text-center hover:shadow-md transition-shadow cursor-pointer">
            ...
            <div class="text-xs text-muted uppercase tracking-widest font-medium">Total Users</div>
        </div>
        <div class="card bg-base-100 border border-base-300  p-5 text-center hover:shadow-md transition-shadow cursor-pointer">
            ...
            <div class="text-xs text-muted uppercase tracking-widest font-medium">Admins</div>
        </div>
        <div class="card bg-base-100 border border-base-300  p-5 text-center hover:shadow-md transition-shadow cursor-pointer">
            ...
            <div class="text-xs text-muted uppercase tracking-widest font-medium">HR Personnel</div>
        </div>
        <div class="card bg-base-100 border border-base-300  p-5 text-center hover:shadow-md transition-shadow cursor-pointer">
            ...
            <div class="text-xs text-muted uppercase tracking-widest font-medium">Active Accounts</div>
        </div>
    </div>
        ...
        <x-data-table maxHeight="53vh">
            ...
            @forelse($users as $user)
                ...
                <tr class="row-hover">
                    ...
                    <td class="text-subtle">{{ $user->email }}</td>
                    ...
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-subtle">{{ $user->email }}</div>
                            </div>
                        </div>
                        @if($user->is_active)
