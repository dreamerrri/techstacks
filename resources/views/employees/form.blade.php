...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-base-content/60">Middle Name</label>
...
<div class="mb-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-base-content/60">SSS Number</label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-base-content/60">PhilHealth Number</label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-base-content/60">Pag-IBIG Number</label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-base-content/60">TIN Number</label>
