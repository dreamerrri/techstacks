...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">First Name <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Middle Name</label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Last Name <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Birthdate <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Gender <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Civil Status <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Contact Number <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Email Address <span class="text-error">*</span></label>
        ...
        <div class="fieldset md:col-span-2 lg:col-span-3">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Address <span class="text-error">*</span></label>
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Department <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Position <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Employment Status <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Date Hired <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Salary Type <span class="text-error">*</span></label>
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Basic Salary (PHP) <span class="text-error">*</span></label>
...
<div class="mb-4">
    <h3 class="text-xs font-semibold uppercase tracking-widest text-faint border-b-2 border-error/20 pb-2 mb-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">SSS Number</label>
            ...
            <p class="field-error label text-error text-xs mt-1 hidden"></p>
            <p class="text-faint text-xs mt-1">Format: XX-XXXXXXX-X</p>
        </div>

        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">PhilHealth Number</label>
            ...
            <p class="field-error label text-error text-xs mt-1 hidden"></p>
            <p class="text-faint text-xs mt-1">Format: XX-XXXXXXXXX-X</p>
        </div>

        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">Pag-IBIG Number</label>
            ...
            <p class="field-error label text-error text-xs mt-1 hidden"></p>
            <p class="text-faint text-xs mt-1">Format: XXXX-XXXX-XXXX</p>
        </div>

        <div class="fieldset">
            <label class="label text-xs font-semibold uppercase tracking-wider text-subtle">TIN Number</label>
            ...
            <p class="field-error label text-error text-xs mt-1 hidden"></p>
            <p class="text-faint text-xs mt-1">Format: XXX-XXX-XXX</p>
        </div>
