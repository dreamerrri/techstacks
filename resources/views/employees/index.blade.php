...
@section('content')
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px; margin-bottom:24px;">
        ...
        <a href="{{ route('employees.create') }}"
           style="padding:10px 20px; background:linear-gradient(135deg,#dc2626,#991b1b); color:white; border-radius:8px; text-decoration:none; font-weight:600; font-size:14px; white-space:nowrap;">
                ...
                <div class="user-card">
                    ...
                    <div class="user-card-meta" style="margin-top:10px; padding-top:10px; border-top:1px solid #f3f4f6; display:flex; gap:8px; flex-wrap:wrap;">
                        ...
                        <form method="POST" action="{{ route('employees.archive', $employee) }}"
                              ...
                              style="display:inline;">
                            @csrf @method('PATCH')
                            <button style="padding:5px 12px; background:#fecaca; color:#991b1b; border:none; border-radius:5px; font-size:12px; cursor:pointer;">
                                <i class="fas fa-archive"></i> Archive
                            </button>
                        </form>
                    </div>
