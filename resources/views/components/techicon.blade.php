...
<a href="{{ route('dashboard') }}" class="techicon flex items-center gap-2 no-underline {{ $minified ? 'justify-center' : '' }}">
    <svg fill="currentColor" height="2em" viewBox="0 0 1813 1441" width="2em" xmlns="http://www.w3.org/2000/svg" class="brand-logo-icon shrink-0 text-base-content">
    ...
    <div class="tech drawer-title overlay-minified:hidden leading-tight">
        <span class="block text-xl font-semibold text-base-content">Techstacks</span>
