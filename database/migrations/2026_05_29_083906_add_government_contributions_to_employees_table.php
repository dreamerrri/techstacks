...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('employees', function (Blueprint $table) {
            ...
            $table->decimal('pagibig_rate', 5, 4)->default(0.0200)->after('philhealth_cap');
    ...
    {
        Schema::table('employees', function (Blueprint $table) {
            $table->dropColumn(['sss_rate', 'sss_cap', 'philhealth_rate', 'philhealth_cap', 'pagibig_rate', 'pagibig_cap']);
        });
    }
};
